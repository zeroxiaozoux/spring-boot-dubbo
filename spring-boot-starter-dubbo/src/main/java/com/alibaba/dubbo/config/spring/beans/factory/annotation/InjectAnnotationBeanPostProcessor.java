...
//
//import com.dubbo.annotation.Inject;
...
//
//    //private static final log log = logFactory.getlog(InjectAnnotationBeanPostProcessor.class);
//
...
//                    log.warn("@Reference 静态方法不支持注释: {}", field);
//                    return;
//                }
...
//                    log.warn("@Reference 静态方法不支持注释: {}", method);
//                    return;
//                }
//                if (method.getParameterTypes().length == 0) {
//                    log.warn("@Reference  注释应该只使用有参数的方法: {}", method);
//                    return;
//                }
//                if (method.getParameterTypes().length > 1) {
//                    log.warn("@Reference  注释应该只使用有一个参数的方法: {}", method);
...
//            }
//        } catch (Exception e) {
//            log.debug("从spring上下文注入资源异常  beanName={} ,requiredType={} ", beanName, requiredType, e);
//            return null;
//        }
//    }
//
...
//                log.info(referenceBean + " was destroying!");
//            }
